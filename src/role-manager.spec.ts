...
describe('RoleManager', () => {
    ...
    it('should add parents via addParents', async () => {
        ...
        expect(await roleManager.getParents('a')).toEqual(new Set([ 'b', 'c' ]));
    
        roleManager.addParents('a', [ 'b', 'd', 'e' ]);
    
        expect(await roleManager.getParents('a')).toEqual(new Set([ 'b', 'c', 'd', 'e' ]));
    });
    ...
    it('should set parents via setParents', async () => {
        ...
        expect(await roleManager.getParents('a')).toEqual(new Set([ 'b', 'd', 'e' ]));
    });
    ...
    it('should return recursively all parents', async () => {
        ...
        expect(await roleManager.getRecursiveParentsOf('a')).toEqual([ 'a', 'b', 'c', 'd' ]);
    });
